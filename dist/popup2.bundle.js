...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var urlsContainer = document.getElementById('urls');
  var roomCode = new URLSearchParams(window.location.search).get('roomCode');
  if (roomCode) {
    var database = (0,firebase_database__WEBPACK_IMPORTED_MODULE_0__.getDatabase)(_src_index_js__WEBPACK_IMPORTED_MODULE_1__.app);
    var urlsRef = (0,firebase_database__WEBPACK_IMPORTED_MODULE_0__.ref)(database, 'rooms/' + roomCode + '/problems');
    (0,firebase_database__WEBPACK_IMPORTED_MODULE_0__.onValue)(urlsRef, function (snapshot) {
      urlsContainer.innerHTML = '';
      snapshot.forEach(function (childSnapshot) {
        var urlData = childSnapshot.val();
...
function createUser(name, roomCode) {
  ...
  (0,firebase_database__WEBPACK_IMPORTED_MODULE_0__.set)((0,firebase_database__WEBPACK_IMPORTED_MODULE_0__.ref)(database, 'rooms/' + roomCode + '/users/' + userId), {
    username: name
  }).then(function () {
...
function addParticipant(name, roomCode) {
  ...
  (0,firebase_database__WEBPACK_IMPORTED_MODULE_0__.push)(participantsRef, {
    username: name
  }).then(function () {
