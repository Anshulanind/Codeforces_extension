...
chrome.runtime.onMessage.addListener(function (message, sender, sendResponse) {
  ...
  if (message.action === "getCurrentTabUrl") {
    ...
    var roomRef = (0,firebase_database__WEBPACK_IMPORTED_MODULE_0__.ref)(database, 'rooms/' + message.roomCode + '/problems');
    (0,firebase_database__WEBPACK_IMPORTED_MODULE_0__.push)(roomRef, {
      url: message.url
    }).then(function () {
